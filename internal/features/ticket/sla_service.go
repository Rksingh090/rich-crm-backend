...
type SLAService interface {
	...
	CalculateSLAStatus(ctx context.Context, ticket *Ticket, policy *SLAPolicy) *SLAStatus
...
func NewSLAService(slaPolicyRepo SLAPolicyRepository, ticketRepo TicketRepository) SLAService {
...
func (s *SLAServiceImpl) CreatePolicy(ctx context.Context, policy *SLAPolicy) error {
	return s.SLAPolicyRepo.Create(ctx, policy)
}

// GetPolicy retrieves an SLA policy by ID
func (s *SLAServiceImpl) GetPolicy(ctx context.Context, id string) (*SLAPolicy, error) {
...
func (s *SLAServiceImpl) ListPolicies(ctx context.Context) ([]SLAPolicy, error) {
...
func (s *SLAServiceImpl) CalculateSLAStatus(ctx context.Context, ticket *Ticket, policy *SLAPolicy) *SLAStatus {
	if policy == nil {
		return &SLAStatus{
			Status:               "no_sla",
