...
type SLAPolicyRepository interface {
	...
	FindByID(ctx context.Context, id primitive.ObjectID) (*SLAPolicy, error)
	FindAll(ctx context.Context) ([]SLAPolicy, error)
	FindByPriority(ctx context.Context, priority TicketPriority) (*SLAPolicy, error)
...
func (r *SLAPolicyRepositoryImpl) Create(ctx context.Context, policy *SLAPolicy) error {
...
func (r *SLAPolicyRepositoryImpl) FindByID(ctx context.Context, id primitive.ObjectID) (*SLAPolicy, error) {
...
func (r *SLAPolicyRepositoryImpl) FindAll(ctx context.Context) ([]SLAPolicy, error) {
...
func (r *SLAPolicyRepositoryImpl) FindByPriority(ctx context.Context, priority TicketPriority) (*SLAPolicy, error) {
	var policy SLAPolicy
