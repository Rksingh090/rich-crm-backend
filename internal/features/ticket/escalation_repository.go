...
type EscalationRuleRepository interface {
	...
	FindByID(ctx context.Context, id primitive.ObjectID) (*EscalationRule, error)
	FindAll(ctx context.Context) ([]EscalationRule, error)
	FindActive(ctx context.Context) ([]EscalationRule, error)
...
func (r *EscalationRuleRepositoryImpl) Create(ctx context.Context, rule *EscalationRule) error {
...
func (r *EscalationRuleRepositoryImpl) FindByID(ctx context.Context, id primitive.ObjectID) (*EscalationRule, error) {
...
func (r *EscalationRuleRepositoryImpl) FindAll(ctx context.Context) ([]EscalationRule, error) {
...
func (r *EscalationRuleRepositoryImpl) FindActive(ctx context.Context) ([]EscalationRule, error) {
