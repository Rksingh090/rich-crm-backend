...
type TicketApi struct {
	...
	metricsController *SLAMetricsController
	config            *config.Config
}

func NewTicketApi(controller *TicketController, metricsController *SLAMetricsController, config *config.Config) *TicketApi {
	return &TicketApi{
