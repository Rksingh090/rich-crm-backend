...
func (r *DataSourceRepositoryImpl) Create(ctx context.Context, dataSource *DataSource) error {
	dataSource.ID = primitive.NewObjectID()
	_, err := r.collection.InsertOne(ctx, dataSource)
	return err
}

func (r *DataSourceRepositoryImpl) Get(ctx context.Context, id string) (*DataSource, error) {
...
func (r *DataSourceRepositoryImpl) List(ctx context.Context) ([]DataSource, error) {
...
func (r *DataSourceRepositoryImpl) FindByType(ctx context.Context, dsType string) ([]DataSource, error) {
