...
type Metric struct {
	...
	Filters         map[string]any     `json:"filters,omitempty" bson:"filters,omitempty"`
...
type MetricResult struct {
	...
	Value     any              `json:"value"`          // Single value or array depending on grouping
	Data      []map[string]any `json:"data,omitempty"` // Raw data if needed
