...
func (r *MetricRepositoryImpl) Create(ctx context.Context, metric *Metric) error {
	metric.ID = primitive.NewObjectID()
	_, err := r.collection.InsertOne(ctx, metric)
	return err
}

func (r *MetricRepositoryImpl) Get(ctx context.Context, id string) (*Metric, error) {
...
func (r *MetricRepositoryImpl) List(ctx context.Context) ([]Metric, error) {
...
func (r *MetricRepositoryImpl) FindByDataSource(ctx context.Context, dataSourceID string) ([]Metric, error) {
...
func (r *MetricRepositoryImpl) FindByModule(ctx context.Context, module string) ([]Metric, error) {
