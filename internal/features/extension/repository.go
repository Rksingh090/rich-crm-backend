...
func (r *ExtensionRepositoryImpl) Create(ctx context.Context, ext *Extension) error {
...
func (r *ExtensionRepositoryImpl) GetByID(ctx context.Context, id string) (*Extension, error) {
...
func (r *ExtensionRepositoryImpl) List(ctx context.Context, onlyInstalled bool) ([]Extension, error) {
	filter := bson.M{}
	if onlyInstalled {
