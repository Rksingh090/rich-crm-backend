...
type SavedFilterService interface {
	CreateFilter(ctx context.Context, filter *models.SavedFilter) error
	GetFilter(ctx context.Context, id string) (*models.SavedFilter, error)
	UpdateFilter(ctx context.Context, filter *models.SavedFilter) error
	DeleteFilter(ctx context.Context, id string, userID primitive.ObjectID) error
	GetUserFilters(ctx context.Context, userID primitive.ObjectID, moduleName string) ([]models.SavedFilter, error)
	GetPublicFilters(ctx context.Context, moduleName string) ([]models.SavedFilter, error)
	BuildQueryFromCriteria(criteria models.FilterCriteria) map[string]interface{}
}
...
func NewSavedFilterService(filterRepo repository.SavedFilterRepository) SavedFilterService {
	return &SavedFilterServiceImpl{
		FilterRepo: filterRepo,
	}
}

func (s *SavedFilterServiceImpl) CreateFilter(ctx context.Context, filter *models.SavedFilter) error {
	return s.FilterRepo.Create(ctx, filter)
}

func (s *SavedFilterServiceImpl) GetFilter(ctx context.Context, id string) (*models.SavedFilter, error) {
	return s.FilterRepo.Get(ctx, id)
}

func (s *SavedFilterServiceImpl) UpdateFilter(ctx context.Context, filter *models.SavedFilter) error {
...
func (s *SavedFilterServiceImpl) GetUserFilters(ctx context.Context, userID primitive.ObjectID, moduleName string) ([]models.SavedFilter, error) {
	return s.FilterRepo.FindByUser(ctx, userID.Hex(), moduleName)
}

func (s *SavedFilterServiceImpl) GetPublicFilters(ctx context.Context, moduleName string) ([]models.SavedFilter, error) {
	return s.FilterRepo.FindPublic(ctx, moduleName)
}

// BuildQueryFromCriteria converts FilterCriteria to MongoDB query
func (s *SavedFilterServiceImpl) BuildQueryFromCriteria(criteria models.FilterCriteria) map[string]interface{} {
...
func (s *SavedFilterServiceImpl) buildConditionQuery(condition models.FilterCondition) map[string]interface{} {
	query := make(map[string]interface{})
