...
type ChartRepository interface {
	...
	Get(ctx context.Context, id string) (*models.Chart, error)
	List(ctx context.Context) ([]models.Chart, error)
	Update(ctx context.Context, id string, chart *models.Chart) error
...
func (r *ChartRepositoryImpl) Create(ctx context.Context, chart *models.Chart) error {
	chart.ID = primitive.NewObjectID()
	_, err := r.Collection.InsertOne(ctx, chart)
	return err
}

func (r *ChartRepositoryImpl) Get(ctx context.Context, id string) (*models.Chart, error) {
...
func (r *ChartRepositoryImpl) List(ctx context.Context) ([]models.Chart, error) {
...
func (r *ChartRepositoryImpl) Update(ctx context.Context, id string, chart *models.Chart) error {
	oid, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return err
	}
