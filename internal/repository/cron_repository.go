...
type CronRepository interface {
	Create(ctx context.Context, cronJob *models.CronJob) error
	GetByID(ctx context.Context, id string) (*models.CronJob, error)
	List(ctx context.Context, filter map[string]interface{}) ([]models.CronJob, error)
	Update(ctx context.Context, cronJob *models.CronJob) error
	Delete(ctx context.Context, id string) error
	GetActive(ctx context.Context) ([]models.CronJob, error)
	UpdateLastRun(ctx context.Context, id string, lastRun time.Time, nextRun *time.Time) error

	// Log operations
	CreateLog(ctx context.Context, log *models.CronJobLog) error
	GetLogs(ctx context.Context, cronJobID string, limit int) ([]models.CronJobLog, error)
	UpdateLog(ctx context.Context, log *models.CronJobLog) error
}
...
func (r *CronRepositoryImpl) Create(ctx context.Context, cronJob *models.CronJob) error {
...
func (r *CronRepositoryImpl) GetByID(ctx context.Context, id string) (*models.CronJob, error) {
...
func (r *CronRepositoryImpl) List(ctx context.Context, filter map[string]interface{}) ([]models.CronJob, error) {
...
func (r *CronRepositoryImpl) Update(ctx context.Context, cronJob *models.CronJob) error {
	cronJob.UpdatedAt = time.Now()
...
func (r *CronRepositoryImpl) GetActive(ctx context.Context) ([]models.CronJob, error) {
...
func (r *CronRepositoryImpl) CreateLog(ctx context.Context, log *models.CronJobLog) error {
...
func (r *CronRepositoryImpl) GetLogs(ctx context.Context, cronJobID string, limit int) ([]models.CronJobLog, error) {
	...
	if logs == nil {
		logs = []models.CronJobLog{}
	}

	return logs, nil
}

func (r *CronRepositoryImpl) UpdateLog(ctx context.Context, log *models.CronJobLog) error {
